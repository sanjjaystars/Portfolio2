...
5. Keep default build settings (or use values from `vercel.json`).
6. Click **Deploy**.
...
- `vercel.json` for explicit Next.js build/dev/install commands
- `.vercelignore` to skip unnecessary files in deploy context
